#TO DO: Add real calibration points and drawing sequence
...
def drawing_sequence(file, pointlist):
    file.write("\n\tPROC drawing_sequence()\n")
    file.write("\t\tMoveJ Dpoint0,v100,z1,BHH_pen\WObj:=Workobject_1;\n")
    for i in range(len(pointlist)-1):
        file.write(f"\t\tMoveL Dpoint{i+1},v100,z1,BHH_pen\WObj:=Workobject_1;\n")
    file.write("\tENDPROC\n\n")
...
def main():
    ...
    define_Drawingpoints(file, [(20,20), (50,50), (30,50)])  # Example drawing points
    plane_finder_sequence(file)
    drawing_sequence(file, [(20,20), (50,50), (30,50)])  # Example drawing points
